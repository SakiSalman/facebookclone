        ...
        <div className="story-box">
            <div className="story-box-header">
              <ul>
                <li>
                  <a href="#">
                    <svg fill="currentColor" viewBox="0 0 20 20" width="1em" height="1em" className="x1lliihq x1k90msu x2h7rmj x1qfuztq x1qq9wsj x1qx5ct2 xw4jnvo">
            ...
            <div className="story-box-body">
              <div className="story-area">
                <div className="story-item auth-user-story" style={{backgroundImage: 'url("./assets/images/user.png")'}}>
                  <div className="auth-story-create">
                    <button>
                      <svg fill="currentColor" viewBox="0 0 20 20" width="1em" height="1em" className="x1lliihq x1k90msu x2h7rmj x1qfuztq x14ctfv x1qx5ct2 xw4jnvo">
                        <g fillRule="evenodd" transform="translate(-446 -350)">
                          <g fillRule="nonzero">
                ...
                <div className="story-item" style={{backgroundImage: 'url("https://images.unsplash.com/photo-1630304565761-d6f8d5a0facd?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8Y3V0ZSUyMGJhYnl8ZW58MHx8MHx8&w=1000&q=80")'}}>
