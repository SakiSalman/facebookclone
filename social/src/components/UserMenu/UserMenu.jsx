...
const UserMenu = ({userDropMenu, handleProfilePage, handleLogout}) => {
...
<div className="fb-user-item" onClick={() => setShowMenu(!showMenu)} >
{showMenu && <div class="user-menu-dropdown" ref={userDropMenu}>
<div class="user-menu-box">
<div class="user-data-box">
  <div onClick={handleProfilePage} class="user-data-box-item">
    <Avatar/>
